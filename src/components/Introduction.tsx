    ...
    return (<>
        <div className="outer-container">
            <div className="profile">
                ...
                <p className="intro-summary">10+ years of technical leadership. From hardware precision in <b className="orange">Delhi</b> to high-scale backend logic. I don't just write code; I build systems that evolve.</p>
